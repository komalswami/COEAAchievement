...
<script>
	function okj()
	{
		var output=document.getElementById("br").value;
		
		document.location.href="getresult.jsp?output="+output;
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
					...
					<div class="col-md-12 form-group">
											...
											<div class="col-md-12 form-group">
						<label for="br">List By:</label>
  <input list="bro" name="br" id="br" class="form-control form-control-lg">
  <datalist id="bro">
    <option value="F.Y">
    <option value="S.Y">
    <option value="T.Y">
    ...
    <option value="2020-2021">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label for="ok"></label>
							<input type="button" value="get records" class="btn btn-primary btn-lg px-5" onclick="okj()">
                        </div>
                    </div>
                </div>
            </div>
